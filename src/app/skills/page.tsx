    ...
    return (
        <div className="min-h-screen py-32 px-6">
            <div className="max-w-[1400px] mx-auto">
                <SectionHeader
                    label="SKILLS.SH"
                    description="Hover over any skill to see how I use it in the field. Every tool earns its place through real-world application."
                />

                {/* Marquee */}
                <div className="w-full overflow-hidden py-4 mb-12 border-y border-border-subtle">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        >
                            {filtered.map((skill, i) => (
                                <motion.div
                                    ...
                                    className={`p-5 rounded-xl border cursor-default transition-all duration-300 group ${
                    ...
                    <div className="lg:col-span-1">
                        <div className="sticky top-24 rounded-2xl border border-border-subtle bg-bg-card/80 backdrop-blur-sm p-8">
